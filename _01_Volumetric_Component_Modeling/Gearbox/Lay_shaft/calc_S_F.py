"""
Description:    This function computes the safety factor against root break according to Decker, p. 150
------------
...
def calc_S_F(gearbox, parameters, shaft):
    ...
    # Safety factor against root break with Y_NT=1.8 (Zaehringer, p. xv)
    S_F = sigma_fe*1.8/sigma_f
    # endregion

    # region [3]: Output Assignment
    if shaft == 1:
        setattr(gearbox.results, 'S_F_12', S_F)       # Safety factor against root break for first stage
    elif shaft == 2:
        setattr(gearbox.results, 'S_F_34', S_F)       # Safety factor against root break for second stage
    # endregion
