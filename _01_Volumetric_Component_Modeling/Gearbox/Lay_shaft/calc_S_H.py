"""
Description:    This function computes the safety factor against flank break, according to Decker, starting p. 151
------------
...
def calc_S_H(gearbox, parameters, shaft):
    ...
    if shaft == 1:
        setattr(gearbox.results, 'S_H_12', S_H)       # Safety factor against flank break for first stage
    elif shaft == 2:
        setattr(gearbox.results, 'S_H_34', S_H)       # Safety factor against flank break for second stage
    # endregion
