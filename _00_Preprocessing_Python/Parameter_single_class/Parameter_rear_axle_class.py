"""
Description: This function has the task to create an empty class for the rear axle parameters
...
Input: None
------------
Output: Class element for all the rear axle parameters
------------
