"""
Description: This function has the task to create an empty class for the groundclearance parameters
...
Input: None
------------
Output: Class element for all the groundclearance parameters
------------
...
class Parameter_groundclearance:
    def __init__(self):
        pass
# endregion
