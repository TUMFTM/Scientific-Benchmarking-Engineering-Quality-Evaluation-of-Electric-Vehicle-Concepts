...
[1] Find the equivalent nested class inside the main_class
[2] Get the desired value of the variable
[3] Check if the variable is part of an array or dictionary
[4] Generate the dictionary
[5] Generate the array
[6] Set the attribute
"""
