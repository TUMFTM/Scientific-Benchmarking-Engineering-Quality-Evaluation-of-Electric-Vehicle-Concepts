"""
Description: This function creates the Radar chart class
------------
Sources:  from https://towardsdatascience.com/how-to-create-and-visualize-complex-radar-charts-f7764d0f3652
------------
Input: None
------------
Output: None
...
class ComplexRadar:
    ...
    def __init__(self, fig, variables, ranges, n_ring_levels, show_scales=True, format_cfg=None):
        ...
        self.format_cfg = {
            ...
            'theta_tick_lbls_txt_wrap': 25,
            'theta_tick_lbls_brk_lng_wrds': True,
            'theta_tick_lbls_pad': 45,
            # Outer ring
        ...
        for i, ax in enumerate(axes):
            ...
            gridlabel = ["{}".format(int(round(x, 2))) for x in grid]
        ...
        labels = ['\n'.join(textwrap.wrap(i, self.format_cfg['theta_tick_lbls_txt_wrap'],
                                          break_long_words=self.format_cfg['theta_tick_lbls_brk_lng_wrds'])) for i in
                  labels]
        ...
        self.ax.tick_params(axis='x', pad=11)
    ...
    def set_title(self, title, pad=30, **kwargs):
        """Set a title"""
