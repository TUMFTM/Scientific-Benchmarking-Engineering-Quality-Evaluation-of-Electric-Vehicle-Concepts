"""
Description: This function stores the required parameters for the laptime simulation in the vehicle struct
------------
------------
...
------------
Output: The vehicle structure updated with the required parameters for the laptime simulation
------------
...
def vehicle_laptime_initialization(vehicle, parameters):
    # region [1] Load desired driving cycle
    # ----------------------------------------------------------------------------------------------------------------------
    # [GENERAL_OPTIONS]

    ### set name of ggv diagram and ax_max_machines files to use
    ggv_file = "GGV_ID3_real.csv"
    ax_max_machines_file = "Kennfeld_ideal_ID3.csv"
